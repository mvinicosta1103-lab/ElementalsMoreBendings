...
public class CommonClass {
    ...
    public static void init() {
        Constants.LOG.info("Inicializando sub-bendings comuns (Gas, Plant, Mud, Crystal, Sand, Glass, Petrification) na 1.21.1...");

        // Mud, Crystal, Sand, Glass e Petrification agora são Elements de
        // verdade, registrados no mod base (ver
        // MudElement/CrystalElement/SandElement/GlassElement/
        // PetrificationElement) — precisam ser instanciados uma vez aqui
        // pra entrarem no registro estático do Elementals. Glass precisa
        // vir depois de Sand só por organização (não há dependência de
        // ordem de registro real, mas GlassElement.canAcquire consulta
        // SandElement.get() em runtime).
        MudElement.register();
